package com.wsj.kk.autobbs.view;
...
/**
 * Created by 20103 on 2017/5/6.
 */

public class JCVideoPlayerCustom extends JCVideoPlayer {
    ...
    protected JCVideoPlayerCustom.DismissControlViewTimerTask mDismissControlViewTimerTask;
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            fullscreenButton.setImageResource(R.drawable.exitfullscreen_normal);
            ...
            fullscreenButton.setImageResource(R.drawable.fullscreen_normal);
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            startButton.setImageResource(R.drawable.pause_normal);
        } else if (currentState == CURRENT_STATE_ERROR) {
            startButton.setImageResource(R.drawable.jc_click_error_selector);
        } else {
            startButton.setImageResource(R.drawable.play_normal);
        }
    }
    ...
    public void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new JCVideoPlayerCustom.DismissControlViewTimerTask();
